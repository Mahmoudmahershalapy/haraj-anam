...
<div class="body">
    <div class="container">
        ...
        <!-- nestedTabs start -->
        <div class=" row tabs-btn">
            <ul class="level_1 col-sm-8 col-md-8 col-lg-8" id="momId0">
                <!-- <?php $__currentLoopData = App\Cat::where('parent_id',null)->orderBy('sort','asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="mainCat" ><a href="<?php echo e(url("tags/$cat->id")); ?>" data-id="<?php echo e($cat->id); ?>" class="tagTab<?php echo e(($loop->first)?' car':''); ?> tag_id_<?php echo e($cat->id); ?>" id="<?php echo e($cat->id); ?>" value="<?php echo e($cat->id); ?>"><img src="<?php echo e(Request::root()); ?>/public/cats/<?php echo e($cat->logo ?? 'more-icon.svg'); ?>" alt=""><span><?php echo e($cat->name); ?></span></a> </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                <li class="mainCat">
                    <a data-id="550" href="<?php echo e(url('tags/550')); ?>" class="tagTab">
                        <img src="<?php echo e(Request::root()); ?>/public/upload/svg_icons/sheep.png" alt="">
                        <span>أغنام</span>
                    </a>
                </li>
                <li class="mainCat">
                    <a data-id="550" href="<?php echo e(url('tags/550')); ?>" class="tagTab">
                        <img src="<?php echo e(Request::root()); ?>/public/upload/svg_icons/eagle.png" alt="">
                        <span>صقور</span>
                    </a>
                </li>
                <li class="mainCat">
                    <a data-id="550" href="<?php echo e(url('tags/550')); ?>" class="tagTab main-icon">
                        <img src="<?php echo e(Request::root()); ?>/public/upload/svg_icons/bbaa.png" alt="">
                        <span>ببغاء</span>
                    </a>
                </li>
            ...
            <div class="commission-btn col-sm-2 col-md-2  col-lg-2 ">
                <a href="<?php echo e(url('commission')); ?>" class="add-btn"> <i class="fa fa-cc-visa "></i> السداد والعمولة</a>
            </div>
        </div>
        ...
        <div class="row">
            <!--             <div class="col-md-3 md-padd_n col-sm-hidden">
                        ...
                        <div class="part_i spec-links">
                            <div class="links am-edit">
                                <ul>
                                    <?php $__currentLoopData = App\Cat::where('parent_id',null)->orderBy('sort','asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="gallerypic" title="<?php echo e($cat->name); ?>" href="<?php echo e(url('tags/'.$cat->id)); ?>" class="tagTab">
                                        <img alt="<?php echo e($cat->name); ?>" src="<?php echo e(url('public/cats/'.$cat->logo)); ?>" title="<?php echo e($cat->name); ?>" class="car_cont sprite-toyota">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="part_i p-form col-md-12">
                        <form class="p-form-selection  col-xs-12 col-sm-12 col-md-4 col-lg-6">
                            <select class="choose-list" name="city" id="brand">
                                <option selected disabled="disabled" value="#">&nbsp; &nbsp; اختر القسم </option>
                                <?php $__currentLoopData = \App\Cat::whereNull('parent_id')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>"><?php echo e($cat->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <select class="choose-list" name="subcity" id="marka">
                                <option selected disabled="disabled" value="#">اختر القسم</option>
                                <?php
                                $sub_cats = \App\Cat::where([
                                ['parent_id','!=',0],
                        ...
                        <div class="p-form-btn  col-xs-6 col-sm-6 col-md-4 col-lg-3">
                            <button class="first-btn"> <img src="<?php echo e(Request::root()); ?>/public/upload/svg_icons/camel.svg"></i> &nbsp; &nbsp; &nbsp; مزاين الإبل</button>
                        </div>
                        <div class="p-form-btn col-xs-6 col-sm-6 col-md-4 col-lg-3">
                            <button>جميع الحيوانات</button>
                        </div>
                    ...
                    <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="content-aligned">
                            ...
                            <form class="spec-links" style="display:none;">
                                <input id="search" required type="search" placeholder="ابحث عن سلعة .." class="searchBox searchToremove" autocomplete="off" id="autocomplete" name="key" required="required" />
                        ...
                        <div>
                            ...
                            <!--        </div>-->
                            <!--    </div>-->
                            <ul class="add-ad" style="list-style: none;padding-inline-start: inherit;">

                                <li class="p-form-btn col-xs-12 col-sm-3 col-md-3">
                                    <button class="filter-btn filter-btn-tab"> <i class="fa fa-plus"></i> اضف اعلانك</button>
                                </li>
                                <li class="notification-icon p-form-btn col-xs-12 col-sm-7 col-md-9">
                                ...
                                <li class="col-xs-12 item-fillter-area citys-box">
                        ...
                        <div class="inneer-adv" <?php echo e(($post->type == 'مطلوب')?'style= background:#fdf5ff' :''); ?>>
                            <div class=" adv-pic">
                                <a href="<?php echo e(url('ads/'.$post->id.'/'.$post->title)); ?>">
                                    ...
                                    <?php else: ?>
                                    <img src="<?php echo e(asset('/public/upload/images/Camel.jpg')); ?> " title="<?php echo e($post->title); ?>">
                                    <?php endif; ?>
                                </a>
                            </div>
                            <div class="content">
                                ...
                                <div class=" adv-tit">
                                    ...
                                    <div class="text">
                                        <span class="pull-right">
                                            ...
                                            <a class="price-ads" href="<?php echo e(url('city/'.$post->Area->name)); ?>"> السعر : 2000 ريال </a>
                                            <a class="location-ads" href="<?php echo e(url('city/'.$post->Area->name)); ?>"><i class="fa fa-map-marker"></i> <?php echo e($post->Area->name); ?> </a>
            ...
            <div class="col-md-12 ads-links">
                <ul class="relatedTags">
                    <?php $__currentLoopData = \App\Area::where('parent_id',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a data-area="<?php echo e($area->id); ?>" href="/city/<?php echo e($area->id); ?>">مواشى وطيور وحيوانات في  <?php echo e($area->name); ?></a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
                <?php endif; ?>
        ...
        <div class="col-lg-12 md-padd_n col-sm-visible">
            <div class="part_i p-form">
    ...
    $(document).on('click', ".relatedTags li a", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('html, body').animate({
                    scrollTop: '30px'
                }, 200); // For Go The Top page before load the data 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/salahmaher/Salah/Work/BackendLaravel/haraj-anam/resources/views/welcome.blade.php ENDPATH**/ ?>