         ...
         <div id="headerWarp" class="clear">
            ...
            <ul style="list-style-type: none;display: flex;">
               ...
               <li class="mainCat2" style="flex-grow: 1;">
                  <a href="<?php echo e(url("tags/$cat->id")); ?>" data-id="<?php echo e($cat->id); ?>" id="<?php echo e($cat->id); ?>"
                     value="<?php echo e($cat->id); ?>"><?php echo e($cat->name); ?></a>
               </li>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <li style="flex-grow: 1;"><a href="<?php echo e(url('pages/advsearch')); ?>"> <i class="fa fa-search"></i> البحث</a>
               </li> 
            </ul>
-->
      ...
      <div class="container" style="background-color: #1E3A9D;">
         <div class="row">
            <div class="col-md-4 col-sm-3 col-xs-6">
               <a class="logo-top" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(Request::root()); ?>/public/upload/logo/logo.png">
            ...
            <div class="col-md-8 col-sm-9 col-xs-6  fixed-nav">
               <ul class="<?php if(auth()->guard()->check()): ?> classs <?php endif; ?>">
                  ...
                  <li class="site-login">
                     ...
                     <?php endif; ?>
                     <a class="divider" href="<?php echo e(Auth::user() ? url('users/'.Auth::user()->id) : route('login')); ?>">
                        <span> <i class="fa fa-user-plus"></i>
                           <?php echo e(Auth::user() ? Auth::user()->name : ' جديد   /'); ?></span>
                     </a>
                     <a href="<?php echo e(Auth::user() ? url('users/'.Auth::user()->id) : route('login')); ?>" style="color: #fff;">
                  ...
                  <li class="user-name-profile">
                     ...
                     <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li class="dropdown-link-hover"><a href="<?php echo e(url('admincp')); ?>"> <i class="fa fa-cog"></i>
                                 الاعدادات</a></li>
                           <?php else: ?>
         ...
         <div class="row">
            ...
            <div class="col-md-4">
               <ul class="footer-list">
                  ...
                  <?php endif; ?>
                  <li class="flist"><a href="<?php echo e(url('commission')); ?>"> <i class="fa fa-cc-mastercard "></i> حساب وسداد
                        العمولة</a></li>
...
<?php /**PATH /media/salahmaher/Salah/Work/BackendLaravel/haraj-anam/resources/views/layouts/app.blade.php ENDPATH**/ ?>