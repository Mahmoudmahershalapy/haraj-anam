        ...
        <table class="table tableMsg table-borderedAds tableextra" style="margin-bottom: 0px;">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="row2" align="right"> <?php echo e(Auth::user()->phone); ?>
...
function upadteEmailPostFunc (e) {
    e.preventDefault();
    var url = '<?php echo e(url("updateemail")); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/moltaqa/public_html/haraj-animals/resources/views/site/users/updatemail.blade.php ENDPATH**/ ?>