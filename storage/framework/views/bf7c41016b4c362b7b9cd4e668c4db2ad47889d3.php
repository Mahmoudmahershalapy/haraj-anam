    ...
    <section class="container center-block">
        <div class="row">
            <div class="col-sm-7 promo">
                ...
                <h4 class="title3"><strong>مثال : </strong> لو تم بيع سلعة بمبلغ 1000 ريال سعودي فأن عمولة الموقع هي ( عشرة ريالات فقد ) .</h4>
                <div class="pay-btm">
            ...
            <div class="col-md-12 col-md-offset-1 form_calc">
                <form class="form-pay" action="<?php echo e(url('tranStore')); ?>" method="post" onsubmit="return formValidate(this);">
                    ...
                    <table class="table tableMsg table-borderedAds tableextra">
                        ...
                        <tr class="col-lg-6">
                            <td>
                                <input class="form-control" type="text" placeholder="رقم الجوال" name="phone" size="20" maxlength="60" value="<?php echo e(Auth::user()->phone); ?>" />
                        ...
                        <tr class="col-lg-6">
                            ...
                            <td>مبلغ العمولة :
                                <?php endif; ?>
                                <input class="form-control" type="text" placeholder="<?php echo e(isset($_GET['plan']) ? 'مبلغ الإشتراك' : 'مبلغ العمولة'); ?>" size="20" maxlength="60" name="amount" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/moltaqa/public_html/haraj-animals/resources/views/site/transfers/commission.blade.php ENDPATH**/ ?>