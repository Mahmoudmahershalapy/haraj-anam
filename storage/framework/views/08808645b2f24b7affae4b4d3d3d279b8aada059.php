            ...
            <ul class="level_1 col-sm-8 col-md-8 col-lg-8" id="momId0">
                ...
                <li class="mainCat">
                    <a data-id="550" href="<?php echo e(url('tags/550')); ?>" class="tagTab">
                        <img src="<?php echo e(Request::root()); ?>/public/upload/svg_icons/اغنام.png" alt="">
                        <span>أغنام</span>
                    </a>
                </li>
                <li class="mainCat">
                    <a data-id="550" href="<?php echo e(url('tags/550')); ?>" class="tagTab">
                        <img src="<?php echo e(Request::root()); ?>/public/upload/svg_icons/صقور.png" alt="">
                        <span>صقور</span>
                    </a>
                </li>
                <li class="mainCat">
                    <a data-id="550" href="<?php echo e(url('tags/550')); ?>" class="tagTab main-icon">
                        <img src="<?php echo e(Request::root()); ?>/public/upload/svg_icons/ببغاء.png" alt="">
                        <span>ببغاء</span>
                    </a>
                </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\moltaqa_haraj_animals\resources\views/welcome.blade.php ENDPATH**/ ?>