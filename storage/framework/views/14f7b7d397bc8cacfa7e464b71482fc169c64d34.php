...
<div class="add-3 container" id="storePost">
	...
	<div class="singleContent">
		...
		<span class="label label-warning">
			...
			<span class="label label-warning">
حجم الفيديو المسموح به <?php echo e((int)\App\SiteSetting::where('name','max_upload_posts_videos')->first()->value); ?>  ميجا او المدة 5 دقائق			</span>
		</div>	<br>
			<br>
			<div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/moltaqa/public_html/haraj-animals/resources/views/site/posts/add/addCar.blade.php ENDPATH**/ ?>