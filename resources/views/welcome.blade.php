    ...
    <div class="container">
        ...
        <div class=" row tabs-btn">
            <ul class="level_1 col-sm-8 col-md-8 col-lg-8" id="momId0">
                <!-- @foreach(App\Cat::where('parent_id',null)->orderBy('sort','asc')->get() as $cat)
                    <li class="mainCat" ><a href="{{url("tags/$cat->id")}}" data-id="{{$cat->id}}" class="tagTab{{($loop->first)?' car':''}} tag_id_{{$cat->id}}" id="{{$cat->id}}" value="{{$cat->id}}"><img src="{{Request::root()}}/public/cats/{{$cat->logo ?? 'more-icon.svg'}}" alt=""><span>{{$cat->name}}</span></a> </li>
                    @endforeach -->
                <li class="mainCat">
                    <a data-id="550" href="{{url('tags/550')}}" class="tagTab">
                        <img src="{{Request::root()}}/public/upload/svg_icons/sheep.png" alt="">
                        <span>أغنام</span>
                    </a>
                </li>
                <li class="mainCat">
                    <a data-id="550" href="{{url('tags/550')}}" class="tagTab">
                        <img src="{{Request::root()}}/public/upload/svg_icons/eagle.png" alt="">
                        <span>صقور</span>
                    </a>
                </li>
                <li class="mainCat">
                    <a data-id="550" href="{{url('tags/550')}}" class="tagTab main-icon">
                        <img src="{{Request::root()}}/public/upload/svg_icons/bbaa.png" alt="">
                        <span>ببغاء</span>
                    </a>
                </li>
            ...
            <div class="commission-btn col-sm-2 col-md-2  col-lg-2 ">
                <a href="{{url('commission')}}" class="add-btn"> <i class="fa fa-cc-visa "></i> السداد والعمولة</a>
            </div>
        </div>
        ...
        <div class="row">
            <!--             <div class="col-md-3 md-padd_n col-sm-hidden">
                        ...
                        <div class="part_i spec-links">
                            <div class="links am-edit">
                                <ul>
                                    @foreach(App\Cat::where('parent_id',null)->orderBy('sort','asc')->get() as $cat)
                                    <a class="gallerypic" title="{{$cat->name}}" href="{{url('tags/'.$cat->id)}}" class="tagTab">
                                        <img alt="{{$cat->name}}" src="{{url('public/cats/'.$cat->logo)}}" title="{{$cat->name}}" class="car_cont sprite-toyota">
                ...
                <div class="row">
                    <div class="part_i p-form col-md-12">
                        ...
                        <div class="p-form-btn  col-xs-6 col-sm-6 col-md-4 col-lg-3">
                            <button class="first-btn"> <img src="{{Request::root()}}/public/upload/svg_icons/camel.svg"></i> &nbsp; &nbsp; &nbsp; مزاين الإبل</button>
                        </div>
                        <div class="p-form-btn col-xs-6 col-sm-6 col-md-4 col-lg-3">
                        ...
                        <div class="inneer-adv" {{($post->type == 'مطلوب')?'style= background:#fdf5ff' :''}}>
                            <div class=" adv-pic">
                                <a href="{{url('ads/'.$post->id.'/'.$post->title)}}">
                                    ...
                                    @else
                                    <img src="{{asset('/public/upload/images/Camel.jpg')}} " title="{{$post->title}}">
                                    @endif
                                </a>
                            </div>
                            <div class="content">
                            ...
                            <p style="text-align:center">{{$post->User->name}}</p>
                                ...
                                <div class=" adv-tit">
                                    ...
                                    <h5><strong>{{$post->type}}</strong></h5>
                                            ...
                                            <a class="price-ads" href="{{url('city/'.$post->Area->name)}}"> السعر : 2000 ريال </a>
                                            <a class="location-ads" href="{{url('city/'.$post->Area->name)}}"><i class="fa fa-map-marker"></i> {{$post->Area->name}} </a>
            ...
            <div class="col-md-12 ads-links">
                <ul class="relatedTags">
                    @foreach(\App\Area::where('parent_id',1)->get() as $area)
                    <li>
                        <a data-area="{{$area->id}}" href="/city/{{$area->id}}">مواشى وطيور وحيوانات في  {{$area->name}}</a>
                    </li>
                    @endforeach
                </ul>
                @endif
