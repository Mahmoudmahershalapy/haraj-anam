                ...
                <form class="form-pay" action="{{url('tranStore')}}" method="post" onsubmit="return formValidate(this);">
                    ...
                    <table class="table tableMsg table-borderedAds tableextra">
                        ...
                        <tr class="col-lg-6">
                            ...
                            <td>مبلغ العمولة :
                                @endif
                                <input class="form-control" required type="text" placeholder="{{isset($_GET['plan']) ? 'مبلغ الإشتراك' : 'مبلغ العمولة'}}" size="20" maxlength="60" name="amount" />
                        ...
                        <tr class="col-lg-6">
                            <td>رقم الإعلان :
                                <input required class="form-control" type="text" size="20" maxlength="60" name="post_id" />
